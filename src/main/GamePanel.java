...
public class GamePanel extends JPanel implements Runnable{
    ...
    private int soundBG = 0;
    private int onlyOnetimeSoundBG = 0;
    ...
    public GamePanel(Main main){
        ...
        gameTimer = new FinishGame(10000, this, main);
        ui = new Ui(this);
...
//        if(onlyOnetimeSoundBG == 0){
//            playMusic(soundBG);
//            onlyOnetimeSoundBG = 1;
//        }
//        else if(onlyOnetimeSoundBG == 1){
//            
//        }
//        else if(onlyOnetimeSoundBG == 2){
//            stopMusic();
//            System.out.println("kuy rai");
//        }
...
//            }
    ...
    public int getOnlyOnetimeSoundBG() {
        return onlyOnetimeSoundBG;
    }

    public void setOnlyOnetimeSoundBG(int onlyOnetimeSoundBG) {
        this.onlyOnetimeSoundBG = onlyOnetimeSoundBG;
    }

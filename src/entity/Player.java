...
public class Player extends Entity{
    ...
    public void getPlayerImage(){
        try{
            up1 = ImageIO.read(new File("res/player/Tanggy_Up_1.png"));
            up2 = ImageIO.read(new File("res/player/Tanggy_Up_2.png"));
            down1 = ImageIO.read(new File("res/player/Tanggy_Down_1.png"));
            down2 = ImageIO.read(new File("res/player/Tanggy_Down_2.png"));
            left1 = ImageIO.read(new File("res/player/Tanggy_Left_1.png"));
            left2 = ImageIO.read(new File("res/player/Tanggy_Left_2.png"));
            right1 = ImageIO.read(new File("res/player/Tanggy_Right_1.png"));
            right2 = ImageIO.read(new File("res/player/Tanggy_Right_2.png"));
            updish1 = ImageIO.read(new File("res/player/Tanggy_Up_With_Dish_1.png"));
            updish2 = ImageIO.read(new File("res/player/Tanggy_Up_With_Dish_2.png"));
            downdish1 = ImageIO.read(new File("res/player/Tanggy_Down_With_Dish1.png"));
            downdish2 = ImageIO.read(new File("res/player/Tanggy_Down_With_Dish_2.png"));
            leftdish1 = ImageIO.read(new File("res/player/Tanggy_Left_With_Dish_1.png"));
            leftdish2 = ImageIO.read(new File("res/player/Tanggy_Left_With_Dish_2.png"));
            rightdish1 = ImageIO.read(new File("res/player/Tanggy_Right_With_Dish_1.png"));
            rightdish2 = ImageIO.read(new File("res/player/Tanggy_Right_With_Dish_2.png"));
        }catch(IOException e){
            e.printStackTrace();
        }
    }
        ...
        // check if customer A is full
            if(tableA == true){
                if(cooldownA.isFinishedA() == true){
                    try {
                        gp.getValueFromOBJ(gp.getObj(), 1).setImage(ImageIO.read(new File("res/objects/Full_Mood1.png")));
        ...
        // check if customer B is full
            if(tableB == true){
                if(cooldownB.isFinishedB() == true){
                    try {
                        gp.getValueFromOBJ(gp.getObj(), 2).setImage(ImageIO.read(new File("res/objects/Full_Mood1.png")));
                    } catch (IOException ex) {
                        Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        // check if customer C is full
            if(tableC == true){
                if(cooldownC.isFinishedC() == true){
                    ...
                    try {
                        gp.getValueFromOBJ(gp.getObj(), 3).setImage(ImageIO.read(new File("res/objects/Full_Mood1.png")));
                    } catch (IOException ex) {
                        Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                        }
        ...
        // check if customer D is full
            if(tableD == true){
                if(cooldownD.isFinishedD() == true){
                    try {
                        gp.getValueFromOBJ(gp.getObj(), 4).setImage(ImageIO.read(new File("res/objects/Full_Mood1.png")));
                    } catch (IOException ex) {
                        Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                        }
            ...
            if(i == 5){
                ...
                switch(objectName){
                    case("Key"): 
                        try {
                            ordered = true;
                            gp.getValueFromOBJ(gp.getObj(), 0).setImage(ImageIO.read(new File("res/objects/Shop_Tew_With_Noodle.png")));
                        } catch (IOException ex) {
                            Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                        }
        ...
        // shop
            if(i == 0 && ordered == true){
                ...
                switch(objectName){
                    case("Shop"):
                        try {
                            gp.getValueFromOBJ(gp.getObj(), 0).setImage(ImageIO.read(new File("res/objects/Shop_Tew.png")));
...
//                        // Atkey
        ...
        // table A
                ...
                switch(objectName){
                    ...
                    if(hasKey > 0 ){
                        try {
                            gp.getValueFromOBJ(gp.getObj(), 1).setImage(ImageIO.read(new File("res/objects/Eat_1.png")));
        ...
        // table B
                ...
                switch(objectName){
                    case("Table"):
                        if(hasKey > 0){
                            try {
                                gp.getValueFromOBJ(gp.getObj(), 2).setImage(ImageIO.read(new File("res/objects/Eat_1.png")));
                            } catch (IOException ex) {
                                Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                            }
                            //atkey remove
                ...
                switch(objectName){
                    case("Table"):
                        if(hasKey > 0){
                            ...
                            try {
                                gp.getValueFromOBJ(gp.getObj(), 3).setImage(ImageIO.read(new File("res/objects/Eat_1.png")));
                            } catch (IOException ex) {
                                Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                            }       
                            //at keyremove
                ...
                switch(objectName){
                    case("Table"):
                        if(hasKey > 0){                          
                            // atkey remove
                            try {
                                gp.getValueFromOBJ(gp.getObj(), 4).setImage(ImageIO.read(new File("res/objects/Eat_1.png")));
                            } catch (IOException ex) {
                                Logger.getLogger(Player.class.getName()).log(Level.SEVERE, null, ex);
                            }
                            //at keyremove
    ...
    public void setCoolDownA(tableACooldown a){
        cooldownA = a;
    }
    
    public tableACooldown getCoolDownA(){
        return  cooldownA;
    }
    
    public void setCoolDownB(tableBCooldown b){
        cooldownB = b;
    }
    
    public tableBCooldown getCoolDownB(){
        return  cooldownB;
    }
    
    public void setCoolDownC(tableCCooldown c){
        cooldownC = c;
    }
    
    public tableCCooldown getCoolDownC(){
        return  cooldownC;
    }
    
    public void setCoolDownD(tableDCooldown d){
        cooldownD = d;
    }
    
    public tableDCooldown getCoolDownD(){
        return  cooldownD;
    }
}
